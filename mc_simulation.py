#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Cement & Concrete / Calcination Floor
=====================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Cement & Concrete (Calcination Floor).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "cement",
    "domain_name": "Cement & Concrete",
    "theorem": "Calcination Floor",
    "classification": "Class 1 \u2014 Impossibility",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 170.0,
    "channels": {
        "C1_climate_damages": {
            "dist": "lognormal",
            "low": 120.0,
            ...
            "high": 400.0,
            "weight": 0.29,
            "description": "Climate damages (process + combustion emissions). 2.3 Gt CO2/yr \u00d7 $120/tonne SCC (central). Net of carbonation offset with 3% temporal-mismatch discount. Range $120-400B. Source: GCCA, IEA, EPA SCC $51-190/tonne."
        },
        "C2_aggregate_extraction": {
            ...
            "high": 105.0,
            "weight": 0.09,
            "description": "Aggregate extraction externalities. 50 Gt/yr sand and gravel \u2014 most extracted solid material on Earth. Fisheries losses, coastal erosion, ecosystem service losses, social costs. Range $45-105B. Source: UNEP Global Sand Observatory, Costanza et al."
        },
        "C3_regulatory_capture": {
            ...
            "high": 75.0,
            "weight": 0.07,
            "description": "Regulatory capture costs. \u20ac5B EU ETS windfall profits, blocked material substitution (NRMCA anti-timber), Buy Clean co-optation. Range $40-75B. Source: ifo Institute, PCA/NRMCA disclosure, GSA procurement data."
        },
        "C4_health_externalities": {
            ...
            "high": 60.0,
            "weight": 0.06,
            "description": "Health externalities from PM2.5, NOx, SO2, heavy metals. EPA NESHAP: 2,500 premature deaths/yr in US alone (2% of global production). Income-adjusted VSL global scaling. Range $30-60B. Source: EPA RIA 2010, WHO air quality data."
        },
        "C5_structural_overdesign": {
            ...
            "high": 80.0,
            "weight": 0.08,
            "description": "Structural overdesign waste. 48% excess material in developing-world construction (60% of global consumption). 660 Mt unnecessary cement/yr. Range $45-80B. Source: Oman engineering surveys, GCCA clinker ratio data, RMI analysis."
        },
        "C6_governance_lockin": {
            ...
            "high": 120.0,
            "weight": 0.12,
            "description": "Governance lock-in and institutional failure. Prescriptive code lock-in, Dangote-style grade manipulation (183% price premium), developing-world code adoption failure. LC3 at <5% despite 40% emission reduction at negative cost. Range $65-120B. Source: World Bank, Dangote/CABCO case, ICC code analysis."
        }
    },
